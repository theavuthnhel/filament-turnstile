...
namespace TheavuthNhel\FilamentTurnstile\Tests;
...
class TestCase extends Orchestra
{
    ...
    protected function setUp(): void
    {
        ...
        Factory::guessFactoryNamesUsing(
            fn (string $modelName) => 'TheavuthNhel\\FilamentTurnstile\\Tests\\Database\\Factories\\'.class_basename($modelName).'Factory'
        );
